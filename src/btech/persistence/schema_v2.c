...
const char BTECH_SPECIAL_SCHEMA_SQL[] =
    ...
    ");"
    "CREATE TABLE btech_unit_configuration ("
    " object_dbref INTEGER PRIMARY KEY, preferred_id TEXT, display_name TEXT,"
    " markings TEXT, assigned_pilot INTEGER"
    ");"
    "CREATE TABLE btech_player_configuration ("
    " player_dbref INTEGER PRIMARY KEY, has_ui INTEGER NOT NULL,"
    " tactical_height INTEGER, tactical_width INTEGER, lrs_height INTEGER,"
    " include_dead INTEGER, include_shutdown INTEGER, include_enemies INTEGER,"
    " include_allies INTEGER, include_target INTEGER, buildings INTEGER,"
    " mechwarrior_template TEXT, has_loadout INTEGER NOT NULL,"
    " armor_head INTEGER, armor_torso INTEGER, armor_hands INTEGER,"
    " armor_feet INTEGER, right_weapon TEXT, left_weapon TEXT,"
    " has_right_ammunition INTEGER, has_left_ammunition INTEGER,"
    " right_ammunition INTEGER, left_ammunition INTEGER,"
    " technician_available_at INTEGER NOT NULL"
    ");"
    "CREATE TABLE btech_map_cargo_configuration ("
    " map_dbref INTEGER PRIMARY KEY, x INTEGER NOT NULL, y INTEGER NOT NULL,"
    " reveal_hint INTEGER NOT NULL"
    ");"
    "CREATE TABLE btech_map_links ("
    " child_dbref INTEGER PRIMARY KEY, parent_dbref INTEGER NOT NULL,"
    " x INTEGER NOT NULL, y INTEGER NOT NULL"
    ");"
    "CREATE TABLE btech_map_entrances ("
    " child_dbref INTEGER NOT NULL, direction INTEGER NOT NULL,"
    " mode INTEGER NOT NULL, x INTEGER NOT NULL, y INTEGER NOT NULL,"
    " offset INTEGER NOT NULL, PRIMARY KEY (child_dbref, direction)"
    ") WITHOUT ROWID;"
