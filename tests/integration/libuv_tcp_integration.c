...
static int write_lua_fixture(const char *directory) {
  ...
  fputs(
      ...
      file);
  fputs(
      "        assert(select(\"#\", btech.unit.set_armor(unit, \"LA\", "
      "{ armor = 12, internal = 6 })) == 0)\n"
      "        local armor = btech.unit.armor(unit, \"LA\")\n"
      ...
      "          operation = \"repair_armor\", section = \"LA\", value = 9\n"
      "        })) == 0)\n"
      "        armor = btech.unit.armor(unit, \"LA\")\n"
      ...
      "20)) == 0)\n"
      "        assert(select(\"#\", btech.unit.set_unit_type(unit, \"Mech\")) "
      "== 0)\n"
      "        assert(select(\"#\", "
      "btech.unit.set_movement_type(unit, \"Biped\")) == 0)\n"
      "        assert(select(\"#\", "
      "btech.unit.add_technology(unit, \"SearchLight\")) == 0)\n"
      "        assert(select(\"#\", "
      "btech.unit.remove_technology(unit, \"SearchLight\")) == 0)\n"
      "        assert(select(\"#\", "
      "btech.unit.clear_technologies(unit, \"infantry\")) == 0)\n"
      "        assert(select(\"#\", btech.unit.reset_critical_slots(unit)) "
      "== 0)\n"
      "        local laser = assert(btech.parts.search(\"*MediumLaser*\")[1])\n"
      "        assert(select(\"#\", btech.unit.install_weapon(unit, {\n"
      "          part = laser, section = \"LA\", slots = { 1 }\n"
      "        })) == 0)\n"
      ...
      "          weapon = ac, section = \"LA\", slot = 2\n"
      "        })) == 0)\n"
      "        assert(select(\"#\", "
      "btech.unit.restock_ammunition(unit, \"LA\", 2)) == 0)\n"
